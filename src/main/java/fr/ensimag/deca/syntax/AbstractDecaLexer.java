...
public abstract class AbstractDecaLexer extends Lexer {
     ...
     * @throws IncludeError when the file was not found.
     */
    CharStream findFile(String name) throws IOException,
        ...
        throw new IncludeError(name, this, getInputStream(), "File not found");
    }
     ...
     *
     * @throws IncludeError When the file could not be found or opened.
     * @throws CircularInclude     When an attempt to perform a circular inclusion is done
     */
    void doInclude(String includeDirective) throws IncludeError, CircularInclude {
        ...
        try {
            ...
            throw new IncludeError(name, this, getInputStream(), "Impossible access to this file");
        }
