...
class DecaRecognitionException extends RecognitionException {
    ...
    Location getLocation() {
        ...
        return new Location(
                ...
                offendingToken.getCharPositionInLine() + offendingToken.getText().length(),
    ...
    public DecaRecognitionException(AbstractDecaLexer recognizer,
        ...
        location = new Location(recognizer.getLine(), recognizer.getLine(), recognizer.getCharPositionInLine(), recognizer.getCharPositionInLine() + 1, recognizer.getSourceName());
