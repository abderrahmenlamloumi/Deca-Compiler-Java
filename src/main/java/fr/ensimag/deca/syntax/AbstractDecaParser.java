...
public abstract class AbstractDecaParser extends Parser {
    ...
    protected Location tokenLocation(Token startToken, Token endToken) {
        return new Location(startToken.getLine(),
                endToken.getLine(),
     ...
     *
     * This is a simple convenience wrapper around {@link Locatable#setLocation(Location)}.
     */
    protected void setLocation(Locatable locatable, Token token) {
        locatable.setLocation(tokenLocation(token));
    }

    protected void setLocation(Tree tree, Token startToken, Token endToken) {
        tree.setLocation(tokenLocation(startToken, endToken));
    }
